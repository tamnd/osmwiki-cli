// Package cli builds the osmwiki command tree on top of the osmwiki library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: osmwiki.DefaultConfig()}

	root := &cobra.Command{
		Use:           "osmwiki",
		Short:         "Search OpenStreetMap wiki",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = osmwiki.NewClient(a.cfg)
	return nil
}
