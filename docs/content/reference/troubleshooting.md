...
Most of these come down to network reality or how osmwiki serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

osmwiki rate-limits like any public site. osmwiki already paces
...
Where a surface is gated, osmwiki reads a cookie or token you supply
...
`osmwiki`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what osmwiki actually did
